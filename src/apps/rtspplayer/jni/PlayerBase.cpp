...
int CPlayerBase::AddPublishServer(std::string url, std::string appName, int localRtpPort, int remoteRtpPort, int serverPort)
{
	return -1; // Not implemented
}

int CPlayerBase::AddS3PublishNode(std::string szId, std::string szHost, std::string szAccessId, std::string szSecKey,
...
int CPlayerBase::RemovePublishServer(std::string url)
{
	int res = 0;
	return res;
}

int CPlayerBase::CreateInputStrm(const char *szInputId, const char *szInputType, const char *szInputUri)
{
	JDBG_LOG(CJdDbg::LVL_TRACE, ("%s:Enter", __FUNCTION__));
	int res = 0;
...
CAvmixInputStrm *CPlayerBase::GetInputStrm(const char *szInputId)
{
	JDBG_LOG(CJdDbg::LVL_TRACE, ("%s:Enter", __FUNCTION__));
...
ConnCtxT *CPlayerBase::GetInputStrmConn(const char *szInputId, int nCodec)
{
...
int CPlayerBase::CreateSwitch(const char *szSwitchId)
{
	JDBG_LOG(CJdDbg::LVL_TRACE, ("%s:Enter", __FUNCTION__));
	int res = 0;
...
CMediaSwitch *CPlayerBase::getSwitch(std::string szSwitchId)
{
	JDBG_LOG(CJdDbg::LVL_TRACE, ("%s:Enter", __FUNCTION__));
 ...
 int CPlayerBase::startSwitch(std::string szSwitchId)
{
	 JDBG_LOG(CJdDbg::LVL_TRACE, ("%s:Enter", __FUNCTION__));
	int res = -1;
...
CS3PublishNode *CPlayerBase::getPublishNode(std::string szPublishNode)
{
	JDBG_LOG(CJdDbg::LVL_TRACE, ("%s:Enter", __FUNCTION__));
...
int CPlayerBase::ConnectSwitchInput(const char *pszSwitchId, const char *szInputId)
{
	JDBG_LOG(CJdDbg::LVL_TRACE, ("%s:Enter", __FUNCTION__));
	int res = -1;
	CMediaSwitch *pPublishSwitch = NULL;
