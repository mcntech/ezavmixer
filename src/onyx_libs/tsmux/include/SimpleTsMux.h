...
private:
	...
	unsigned char  *m_pMuxBuffer;

	unsigned char  *m_pLMEM_SYS_MUX_TS_BASE;
	unsigned char  *m_pPES_HEADER_FLAGS_VIDEO;
	unsigned char  *m_pPES_HEADER_FLAGS_AUDIO;
	unsigned char  *m_pTS_HEADER_ADDRESS_UNIT_START_VIDEO;
	unsigned char  *m_pTS_HEADER_ADDRESS_UNIT_CONTINUE_VIDEO;
	unsigned char  *m_pTS_HEADER_ADDRESS_UNIT_START_AUDIO;
	unsigned char  *m_pTS_HEADER_ADDRESS_UNIT_CONTINUE_AUDIO;
	unsigned char  *m_pTS_HEADER_ADDRESS_UNIT_START_PCM;
	unsigned char  *m_pTS_HEADER_ADDRESS_UNIT_CONTINUE_PCM;
	unsigned char  *m_pTS_HEADER_ADDRESS_UNIT_PTS;

	unsigned char  *m_pTS_HEADER_ADDRESS_UNIT_START_PAT;
	unsigned char  *m_pTS_HEADER_ADDRESS_UNIT_START_PMT;
	unsigned char  *m_pPAT_TABLE_ADDRESS;
	unsigned char  *m_pPMT_TABLE_ADDRESS;
	unsigned char  *m_pTS_NULL_PACKETS;
};
