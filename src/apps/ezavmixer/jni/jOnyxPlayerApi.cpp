...
jlong Java_com_mcntech_ezavmixer_OnyxPlayerApi_init(JNIEnv *env, jobject self)
{
...
jboolean Java_com_mcntech_ezavmixer_OnyxPlayerApi_deinit(JNIEnv *env, jobject self, jlong ctx)
{
	pthread_mutex_lock(&g_mutex);
...
int Java_com_mcntech_ezavmixer_OnyxPlayerApi_addServer(JNIEnv *env, jobject self, jlong ctx, jstring jurl)
{
...
int Java_com_mcntech_ezavmixer_OnyxPlayerApi_removeServer(JNIEnv *env, jobject self, jlong ctx, jstring jurl)
{
	const char *szUrl = env->GetStringUTFChars(jurl, 0);
	std::string url = szUrl;
	CPlayerBase* pPlayer = (CPlayerBase*)ctx;
...
int Java_com_mcntech_ezavmixer_OnyxPlayerApi_getStatus(JNIEnv *env, jobject self, jlong ctx, jstring jurl, std::string &status)
{
...
int Java_com_mcntech_ezavmixer_OnyxPlayerApi_startServer(JNIEnv *env, jobject self, jlong ctx, jstring jurl)
{
	const char *szUrl = env->GetStringUTFChars(jurl, 0);
	std::string url = szUrl;
	CPlayerBase* pPlayer = (CPlayerBase*)ctx;
...
int Java_com_mcntech_ezavmixer_OnyxPlayerApi_stopServer(JNIEnv *env, jobject self, jlong ctx, jstring jurl)
{
	const char *szUrl = env->GetStringUTFChars(jurl, 0);
	std::string url = szUrl;
	CPlayerBase* pPlayer = (CPlayerBase*)ctx;
...
jint Java_com_mcntech_ezavmixer_OnyxPlayerApi_getVideoFrame(JNIEnv *env, jobject self, jlong ctx, jstring jurl, jobject buf, jint numBytes, jint nTimeoutMs)
{
	const char *szUrl = env->GetStringUTFChars(jurl, 0);
	std::string url = szUrl;
...
jlong Java_com_mcntech_ezavmixer_OnyxPlayerApi_getVideoPts(JNIEnv *env, jobject self, jlong ctx, jstring jurl)
{
	const char *szUrl = env->GetStringUTFChars(jurl, 0);
	std::string url = szUrl;
...
jlong Java_com_mcntech_ezavmixer_OnyxPlayerApi_getClockUs(JNIEnv *env, jobject self, jlong ctx,jstring jurl)
{
	//pthread_mutex_lock(&g_mutex);
	CPlayerBase* pPlayer = (CPlayerBase*)ctx;
	jlong clock = 0;
...
jint Java_com_mcntech_ezavmixer_OnyxPlayerApi_getVidCodecType(JNIEnv *env, jobject self, jlong ctx, jstring jurl)
{
	const char *szUrl = env->GetStringUTFChars(jurl, 0);
	std::string url = szUrl;
...
jint Java_com_mcntech_ezavmixer_OnyxPlayerApi_getAudCodecType(JNIEnv *env, jobject self, jlong ctx, jstring jurl)
{
	const char *szUrl = env->GetStringUTFChars(jurl, 0);
	std::string url = szUrl;
...
jint Java_com_mcntech_ezavmixer_OnyxPlayerApi_getAudioFrame(JNIEnv *env, jobject self, jlong ctx, jstring jurl, jobject buf, jint numBytes, jint nTimeoutMs)
{
	const char *szUrl = env->GetStringUTFChars(jurl, 0);
	std::string url = szUrl;
...
jlong Java_com_mcntech_ezavmixer_OnyxPlayerApi_getAudioPts(JNIEnv *env, jobject self, jlong ctx, jstring jurl)
{
	const char *szUrl = env->GetStringUTFChars(jurl, 0);
	std::string url = szUrl;
...
jlong Java_com_mcntech_ezavmixer_OnyxPlayerApi_getNumAvailVideoFrames(JNIEnv *env, jobject self, jlong ctx, jstring jurl)
{
	const char *szUrl = env->GetStringUTFChars(jurl, 0);
	std::string url = szUrl;
...
jlong Java_com_mcntech_ezavmixer_OnyxPlayerApi_getNumAvailAudioFrames(JNIEnv *env, jobject self, jlong ctx, jstring jurl)
{
	const char *szUrl = env->GetStringUTFChars(jurl, 0);
	std::string url = szUrl;
...
/*
int Java_com_mcntech_ezavmixer_OnyxPlayerApi_onvifDiscvrStart(JNIEnv *env, jobject self, jlong ctx) {
...
void Java_com_mcntech_ezavmixer_OnyxPlayerApi_onvifDiscvrStop(JNIEnv *env, jobject self, jlong ctx) {
