...
import com.mcntech.ezavmixer.CodecInfo;
import com.mcntech.ezavmixer.Configure;
import com.mcntech.ezavmixer.OnyxPlayerApi;
import com.mcntech.ezavmixer.R;
import com.mcntech.ezavmixer.VideoFeedList.DecPipeBase;



public class DecodeToTexture implements DecPipeBase {
	...
	public DecodeToTexture(Activity activity, String url, int maxVidWidth, int maxVidHeight) {
