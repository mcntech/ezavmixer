 ...
 */
public class VideoMixerActivity extends Activity implements SurfaceHolder.Callback,
    ...
    public interface VideoFeedControl {
    ...
    static class ActivityHandler extends Handler {
        ...
        private WeakReference<VideoMixerActivity> mWeakActivity;

        public ActivityHandler(VideoMixerActivity activity) {
            mWeakActivity = new WeakReference<VideoMixerActivity>(activity);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            VideoMixerActivity activity = mWeakActivity.get();
            if (activity == null) {
